...
<div class="glass-card p-10 rounded-[2.5rem] w-full max-w-[420px]">
    <h2 class="text-3xl font-bold text-white text-center tracking-tight mb-2">Quên mật khẩu</h2>
    <p class="text-indigo-300/60 text-center text-sm mb-8">Nhập email để nhận link đặt lại mật khẩu</p>
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
        ...
        <div>
            <label class="block text-xs font-semibold text-indigo-300 uppercase tracking-widest mb-2 ml-1">Email</label>
            <input type="" name="email" required value="{{ old('email') }}"
